    ...
    <section className="py-24 lg:py-32 bg-midnight relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        >
          ...
          <p className="text-mist text-lg">{t('test.subtitle')}</p>
          <div className="flex items-center justify-center gap-1 mt-4">
            {[1, 2, 3, 4, 5].map(i => (
              <Star key={i} className="w-5 h-5 fill-amber text-amber" />
            ))}
            <span className="ml-2 font-mono font-bold text-amber">4.9/5</span>
            <span className="text-mist text-sm ml-2">Trustpilot</span>
          </div>
        </motion.div>
